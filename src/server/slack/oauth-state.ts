 ...
 * anything tampered with or older than 10 minutes. Same scheme as
 * `server/notion/oauth-state.ts`.
 */
...
export function verifySlackOAuthState(state: string): StatePayload | null {
